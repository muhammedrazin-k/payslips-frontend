...
const AddEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMsg(err.response?.data?.message || err.message || "Failed to add employee");
    } finally {
    ...
    <div className="min-h-screen bg-gray-50/50 py-10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Add New Employee</h2>
            <p className="mt-1 text-sm text-gray-500">
              Enter the details of the new team member to add them to the system.
            </p>
          </div>
          <Link
            to="/"
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <form onSubmit={handleSubmit} className="divide-y divide-gray-200">
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input type="text" id="userId" name="userId" required value={form.userId} onChange={handleChange} className={inputTheme} placeholder="EMP-001" />
                </div>
                <div>
            ...
            <div className="px-6 py-5 bg-gray-50 border-t border-gray-200 flex items-center justify-end gap-4 sm:px-8">
              <Link to="/" className="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors shadow-sm">
                Cancel
              </Link>
              <button
                type="submit"
